...
function adicionarJogadores() {
    ...
    for (var i = 0; i < jogadores.length; i++) {
      ...
      pPosicao.textContent = "Posição: " + jogador.posicao;
      divJogador.appendChild(pPosicao);
  
      var pIdade = document.createElement("p");
      pIdade.textContent = "Idade: " + jogador.nascimento;
      divJogador.appendChild(pIdade);
  ...
  function adicionarEventoAmpliarImagem() {
    // Selecione todas as imagens dos jogadores
    var imagensJogadores = document.querySelectorAll(".jogador img");
  
    // Adicione um evento de passar o mouse por cima de cada imagem
    imagensJogadores.forEach(function(imagem) {
      imagem.addEventListener("mouseover", function() {
        ...
        caixaTexto.classList.add("caixa-texto");
        caixaTexto.textContent = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
  
        // Define a largura e altura da caixa de texto igual à imagem ampliada
        caixaTexto.style.width = this.offsetWidth + "px";
        caixaTexto.style.height = this.offsetHeight + "px";
  
        // Insere a caixa de texto logo após a imagem
        this.parentNode.insertBefore(caixaTexto, this.nextSibling);
      });
  
      imagem.addEventListener("mouseout", function() {
        this.classList.remove("ampliar-imagem");
  
        // Remove a caixa de texto ao retirar o mouse
        var caixaTexto = this.nextSibling;
